...
import pasta.music.adapters.AboutAdapter;
import pasta.music.data.TextListData;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        setFab(true, R.drawable.ic_star, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=pasta.music")));
            }
        });
